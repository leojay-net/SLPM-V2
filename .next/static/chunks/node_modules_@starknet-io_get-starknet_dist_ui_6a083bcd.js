...
"[project]/node_modules/@starknet-io/get-starknet/dist/ui.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function update(t) {
    if (t.fragment !== null) {
        ...
        t.dirty = [
            -1
        ], t.fragment && t.fragment.p(t.ctx, e), t.after_update.forEach(add_render_callback);
    }
}
...
function init$1(t, e, r, n, o, s, i) {
    let a = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : [
        -1
    ];
    ...
    i && i(l.root);
    let u = !1;
    if (l.ctx = r ? r(t, e.props || {}, function(d, h) {
        for(var _len = arguments.length, m = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++){
            m[_key - 2] = arguments[_key];
        }
...
function create_fragment(t) {
    ...
    for(let g = 0; g < m.length; g += 1)p[g] = create_each_block_1(get_each_context_1(t, m, g));
    let y = t[0], b = [];
    for(let g = 0; g < y.length; g += 1)b[g] = create_each_block(get_each_context(t, y, g));
    return {
        c () {
        ...
        m (g, I) {
            ...
            for(let M = 0; M < p.length; M += 1)p[M] && p[M].m(c, null);
            append(c, l);
            for(let M = 0; M < b.length; M += 1)b[M] && b[M].m(c, null);
            d || (h = [
                listen(i, "click", t[10]),
                listen(i, "keyup", t[11]),
...
function instance(t, e, r) {
    ...
    let { lastWallet: o = null } = e, { installedWallets: s = [] } = e, { authorizedWallets: i = [] } = e, { discoveryWallets: a = [] } = e, { callback: c = async ()=>{} } = e, { theme: l = null } = e, u = !1, d = async (w)=>{
        var N;
        r(1, u = (N = w == null ? void 0 : w.id) != null ? N : !1), await c(w).catch(()=>{}), r(1, u = !1);
    }, h = "";
    ...
    onMount(()=>{
        if (l === null) return n == null || n.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", m), ()=>{
...
class Modal extends SvelteComponent {
    constructor(e){
        super(), init$1(this, e, instance, create_fragment, safe_not_equal, {
            lastWallet: 5,
            installedWallets: 6,
            authorizedWallets: 7,
            discoveryWallets: 0,
...
async function show(param) {
    let { discoveryWallets: t, installedWallets: e, lastWallet: r, authorizedWallets: n, enable: o, modalOptions: s } = param;
...
var te = Object.defineProperty, re = (t, e, r)=>e in t ? te(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: r
    }) : t[e] = r, O = (t, e, r)=>(re(t, typeof e != "symbol" ? e + "" : e, r), r), Z = (t, e, r)=>{
...
const generateUID = ()=>"".concat(Date.now(), "-").concat(Math.floor(Math.random() * 8999999999999) + 1e12), shuffle = (t)=>{
...
function error(t) {
    throw t instanceof Error ? (t.message = "".concat(LOG_CATEGORY$1, ": ").concat(t.message), t) : new Error("".concat(LOG_CATEGORY$1, ": ").concat(t));
}
function warn$1(t) {
    t instanceof Error ? (t.message = "".concat(LOG_CATEGORY$1, ": ").concat(t.message), console.warn(t)) : console.warn("".concat(LOG_CATEGORY$1, ": ").concat(t));
}
function addUniqueItem(t, e) {
    return t.findIndex((r)=>r === e) === -1 && t.push(e), t;
}
function getFMId(t) {
    return "version" in t && t.version ? "".concat(t.name, ":").concat(t.version) : "entry" in t && t.entry ? "".concat(t.name, ":").concat(t.entry) : "".concat(t.name);
}
...
function _object_without_properties_loose$1(t, e) {
    ...
    for(s = 0; s < n.length; s++)o = n[s], !(e.indexOf(o) >= 0) && (r[o] = t[o]);
    return r;
}
const nativeGlobal = (()=>{
    try {
...
function setGlobalFederationConstructor(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : isDebugMode$1();
...
function getInfoWithoutType(t, e) {
    if (typeof e == "string") {
        ...
        };
        {
            ...
            for (const n of r){
                const [o, s] = n.split(":"), i = "".concat(o, ":").concat(e), a = t[i];
                if (a) return {
                    value: a,
                    key: i
                };
...
const getGlobalSnapshot = ()=>nativeGlobal.__FEDERATION__.moduleInfo, getTargetSnapshotInfoByModuleInfo = (t, e)=>{
    ...
    const r = e || "__FEDERATION_".concat(t, ":custom__"), n = globalThis[r];
    return {
        remoteEntryKey: r,
        entryExports: n
    };
}, getGlobalHostPlugins = ()=>nativeGlobal.__FEDERATION__.__GLOBAL_PLUGIN__, getPreloaded = (t)=>globalThis.__FEDERATION__.__PRELOADED_MAP__.get(t), setPreloaded = (t)=>globalThis.__FEDERATION__.__PRELOADED_MAP__.set(t, !0), DEFAULT_SCOPE = "default", DEFAULT_REMOTE_TYPE = "global", buildIdentifier = "[0-9A-Za-z-]+", build = "(?:\\+(".concat(buildIdentifier, "(?:\\.").concat(buildIdentifier, ")*))"), numericIdentifier = "0|[1-9]\\d*", numericIdentifierLoose = "[0-9]+", nonNumericIdentifier = "\\d*[a-zA-Z-][a-zA-Z0-9-]*", preReleaseIdentifierLoose = "(?:".concat(numericIdentifierLoose, "|").concat(nonNumericIdentifier, ")"), preReleaseLoose = "(?:-?(".concat(preReleaseIdentifierLoose, "(?:\\.").concat(preReleaseIdentifierLoose, ")*))"), preReleaseIdentifier = "(?:".concat(numericIdentifier, "|").concat(nonNumericIdentifier, ")"), preRelease = "(?:-(".concat(preReleaseIdentifier, "(?:\\.").concat(preReleaseIdentifier, ")*))"), xRangeIdentifier = "".concat(numericIdentifier, "|x|X|\\*"), xRangePlain = "[v=\\s]*(".concat(xRangeIdentifier, ")(?:\\.(").concat(xRangeIdentifier, ")(?:\\.(").concat(xRangeIdentifier, ")(?:").concat(preRelease, ")?").concat(build, "?)?)?"), hyphenRange = "^\\s*(".concat(xRangePlain, ")\\s+-\\s+(").concat(xRangePlain, ")\\s*$"), mainVersionLoose = "(".concat(numericIdentifierLoose, ")\\.(").concat(numericIdentifierLoose, ")\\.(").concat(numericIdentifierLoose, ")"), loosePlain = "[v=\\s]*".concat(mainVersionLoose).concat(preReleaseLoose, "?").concat(build, "?"), gtlt = "((?:<|>)?=?)", comparatorTrim = "(\\s*)".concat(gtlt, "\\s*(").concat(loosePlain, "|").concat(xRangePlain, ")"), loneTilde = "(?:~>?)", tildeTrim = "(\\s*)".concat(loneTilde, "\\s+"), loneCaret = "(?:\\^)", caretTrim = "(\\s*)".concat(loneCaret, "\\s+"), star = "(<|>)?=?\\s*\\*", caret = "^".concat(loneCaret).concat(xRangePlain, "$"), mainVersion = "(".concat(numericIdentifier, ")\\.(").concat(numericIdentifier, ")\\.(").concat(numericIdentifier, ")"), fullPlain = "v?".concat(mainVersion).concat(preRelease, "?").concat(build, "?"), tilde = "^".concat(loneTilde).concat(xRangePlain, "$"), xRange = "^".concat(gtlt, "\\s*").concat(xRangePlain, "$"), comparator = "^".concat(gtlt, "\\s*(").concat(fullPlain, ")$|^$"), gte0 = "^\\s*>=\\s*0.0.0\\s*$";
...
function combineVersion(t, e, r, n) {
    const o = "".concat(t, ".").concat(e, ".").concat(r);
    return n ? "".concat(o, "-").concat(n) : o;
}
function parseHyphen(t) {
    return t.replace(parseRegex(hyphenRange), (e, r, n, o, s, i, a, c, l, u, d, h)=>(isXVersion(n) ? r = "" : isXVersion(o) ? r = ">=".concat(n, ".0.0") : isXVersion(s) ? r = ">=".concat(n, ".").concat(o, ".0") : r = ">=".concat(r), isXVersion(l) ? c = "" : isXVersion(u) ? c = "<".concat(Number(l) + 1, ".0.0-0") : isXVersion(d) ? c = "<".concat(l, ".").concat(Number(u) + 1, ".0-0") : h ? c = "<=".concat(l, ".").concat(u, ".").concat(d, "-").concat(h) : c = "<=".concat(c), "".concat(r, " ").concat(c).trim()));
}
...
function parseCarets(t) {
    return t.trim().split(/\s+/).map((e)=>e.replace(parseRegex(caret), (r, n, o, s, i)=>isXVersion(n) ? "" : isXVersion(o) ? ">=".concat(n, ".0.0 <").concat(Number(n) + 1, ".0.0-0") : isXVersion(s) ? n === "0" ? ">=".concat(n, ".").concat(o, ".0 <").concat(n, ".").concat(Number(o) + 1, ".0-0") : ">=".concat(n, ".").concat(o, ".0 <").concat(Number(n) + 1, ".0.0-0") : i ? n === "0" ? o === "0" ? ">=".concat(n, ".").concat(o, ".").concat(s, "-").concat(i, " <").concat(n, ".").concat(o, ".").concat(Number(s) + 1, "-0") : ">=".concat(n, ".").concat(o, ".").concat(s, "-").concat(i, " <").concat(n, ".").concat(Number(o) + 1, ".0-0") : ">=".concat(n, ".").concat(o, ".").concat(s, "-").concat(i, " <").concat(Number(n) + 1, ".0.0-0") : n === "0" ? o === "0" ? ">=".concat(n, ".").concat(o, ".").concat(s, " <").concat(n, ".").concat(o, ".").concat(Number(s) + 1, "-0") : ">=".concat(n, ".").concat(o, ".").concat(s, " <").concat(n, ".").concat(Number(o) + 1, ".0-0") : ">=".concat(n, ".").concat(o, ".").concat(s, " <").concat(Number(n) + 1, ".0.0-0"))).join(" ");
}
function parseTildes(t) {
    return t.trim().split(/\s+/).map((e)=>e.replace(parseRegex(tilde), (r, n, o, s, i)=>isXVersion(n) ? "" : isXVersion(o) ? ">=".concat(n, ".0.0 <").concat(Number(n) + 1, ".0.0-0") : isXVersion(s) ? ">=".concat(n, ".").concat(o, ".0 <").concat(n, ".").concat(Number(o) + 1, ".0-0") : i ? ">=".concat(n, ".").concat(o, ".").concat(s, "-").concat(i, " <").concat(n, ".").concat(Number(o) + 1, ".0-0") : ">=".concat(n, ".").concat(o, ".").concat(s, " <").concat(n, ".").concat(Number(o) + 1, ".0-0"))).join(" ");
}
function parseXRanges(t) {
    return t.split(/\s+/).map((e)=>e.trim().replace(parseRegex(xRange), (r, n, o, s, i, a)=>{
            ...
            return n === "=" && u && (n = ""), a = "", c ? n === ">" || n === "<" ? "<0.0.0-0" : "*" : n && u ? (l && (s = 0), i = 0, n === ">" ? (n = ">=", l ? (o = Number(o) + 1, s = 0, i = 0) : (s = Number(s) + 1, i = 0)) : n === "<=" && (n = "<", l ? o = Number(o) + 1 : s = Number(s) + 1), n === "<" && (a = "-0"), "".concat(n + o, ".").concat(s, ".").concat(i).concat(a)) : l ? ">=".concat(o, ".0.0").concat(a, " <").concat(Number(o) + 1, ".0.0-0") : u ? ">=".concat(o, ".").concat(s, ".0").concat(a, " <").concat(o, ".").concat(Number(s) + 1, ".0-0") : r;
        })).join(" ");
}
...
function comparePreRelease(t, e) {
    ...
    for(let o = 0, s = r.length; o <= s; o++){
        const i = r[o], a = n[o];
        if (i !== a) return i === void 0 && a === void 0 ? 0 : i ? a ? compareAtom(i, a) : -1 : 1;
    }
    return 0;
}
...
function formatShare(t, e, r) {
    ...
    "get" in t ? n = t.get : "lib" in t ? n = ()=>Promise.resolve(t.lib) : n = ()=>Promise.resolve(()=>{
            throw new Error("Can not get shared '".concat(r, "'!"));
        });
    var o, s;
    return _extends$8({
        deps: [],
        ...
        shareConfig: _extends$8({
            requiredVersion: "^".concat(t.version),
            singleton: !1,
            eager: !1,
            strictVersion: !1
        }, t.shareConfig),
...
function getRegisteredShare(t, e, r, n) {
    ...
    for (const c of a)if (o && t[c] && t[c][e]) {
        const { requiredVersion: l } = o, u = getFindShareFunction(i)(t, c, e), d = ()=>{
            if (o.singleton) {
                if (typeof l == "string" && !satisfy(u, l)) {
                    const m = "Version ".concat(u, " from ").concat(u && t[c][e][u].from, " of shared singleton module ").concat(e, " does not satisfy the requirement of ").concat(r.from, " which needs ").concat(l, ")");
                    o.strictVersion ? error(m) : warn$1(m);
                }
                return t[c][e][u];
            } else {
                if (l === !1 || l === "*" || satisfy(u, l)) return t[c][e][u];
                for (const [m, p] of Object.entries(t[c][e]))if (satisfy(m, l)) return p;
            }
        }, h = {
            shareScopeMap: t,
            scope: c,
...
function _unsupported_iterable_to_array$2(t, e) {
    if (t) {
        ...
        if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return _array_like_to_array$2(t, e);
    }
}
...
function _unsupported_iterable_to_array(t, e) {
    if (t) {
        ...
        var r = Object.prototype.toString.call(t).slice(8, -1);
        if (r === "Object" && t.constructor && (r = t.constructor.name), r === "Map" || r === "Set") return Array.from(r);
        if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return _array_like_to_array(t, e);
    }
}
...
async function loadEsmEntry(param) {
    let { entry: t, remoteEntryExports: e } = param;
    return new Promise((r, n)=>{
        try {
            e ? r(e) : new Function("callbacks", 'import("'.concat(t, '").then(callbacks[0]).catch(callbacks[1])'))([
                r,
                n
            ]);
        } catch (o) {
...
async function loadEntryScript(param) {
    let { name: t, globalName: e, entry: r, createScriptHook: n } = param;
    ...
    return o || (typeof document > "u" ? loadScriptNode(r, {
        ...
        return assert(i, "\n        Unable to use the ".concat(t, "'s '").concat(r, "' URL with ").concat(s, "'s globalName to get remoteEntry exports.\n        Possible reasons could be:\n\n        1. '").concat(r, "' is not the correct URL, or the remoteEntry resource or name is incorrect.\n\n        2. ").concat(s, " cannot be used to get remoteEntry exports in the window object.\n      ")), i;
    }).catch((s)=>{
        throw s;
    }) : loadScript(r, {
        attrs: {},
...
async function getRemoteEntry(param) {
    let { remoteEntryExports: t, remoteInfo: e, createScriptHook: r } = param;
    ...
    async getEntry() {
        ...
        const t = await getRemoteEntry({
            ...
            createScriptHook: (e)=>{
                ...
                if (!!r && (typeof document > "u" || r instanceof HTMLScriptElement || "script" in r || "timeout" in r)) return r;
            }
        });
        return assert(t, "remoteEntryExports is undefined \n ".concat(safeToString$1(this.remoteInfo))), this.remoteEntryExports = t, this.remoteEntryExports;
    }
    async get(t, e, r) {
        ...
        assert(s, "".concat(getFMId(this.remoteInfo), " remote don't export ").concat(e, "."));
...
class SyncWaterfallHook extends SyncHook {
    emit(e) {
        isObject(e) || error('The data for the "'.concat(this.type, '" hook should be an object.'));
...
class AsyncWaterfallHook extends SyncHook {
    emit(e) {
        isObject(e) || error('The response data for the "'.concat(this.type, '" hook must be an object.'));
        const r = Array.from(this.listeners);
        if (r.length > 0) {
            let n = 0;
            const o = (i)=>(warn$1(i), this.onerror(i), e), s = (i)=>{
                if (checkReturnData(e, i)) {
                    if (e = i, n < r.length) try {
                        return Promise.resolve(r[n++](e)).then(s, o);
                    } catch (a) {
                        return o(a);
                    }
                } else this.onerror('A plugin returned an incorrect value for the "'.concat(this.type, '" type.'));
                return e;
            };
...
class PluginSystem {
    ...
    removePlugin(e) {
        ...
        assert(r, 'The plugin "'.concat(e, '" is not registered.')), Object.keys(r).forEach((n)=>{
            n !== "name" && this.lifecycle[n].remove(r[n]);
        });
    }
    inherit(param) {
        let { lifecycle: e, registerPlugins: r } = param;
        Object.keys(e).forEach((n)=>{
            assert(!this.lifecycle[n], 'The hook "'.concat(n, '" has a conflict and cannot be inherited.')), this.lifecycle[n] = e[n];
        }), Object.keys(r).forEach((n)=>{
            assert(!this.registerPlugins[n], 'The plugin "'.concat(n, '" has a conflict and cannot be inherited.')), this.applyPlugin(r[n]);
        });
    }
    constructor(e){
...
function formatPreloadArgs(t, e) {
    return e.map((r)=>{
        ...
        return assert(n, "Unable to preload ".concat(r.nameOrAlias, " as it is not included in ").concat(!n && safeToString$1({
            remoteInfo: n,
            remotes: t
        }))), {
            remote: n,
    ...
    e.options.inBrowser && (i.forEach((a)=>{
        ...
        getRemoteEntry(l ? {
            ...
            createScriptHook: (u)=>{
                ...
                if (!!d && (typeof document > "u" || d instanceof HTMLScriptElement || "script" in d || "timeout" in d)) return d;
            }
        } : {
            remoteInfo: c,
...
function assignRemoteInfo(t, e) {
    (!("remoteEntry" in e) || !e.remoteEntry) && error("The attribute remoteEntry of ".concat(name, " must not be undefined."));
    const { remoteEntry: r } = e;
    let n = getResourceUrl(e, r);
    !isBrowserEnv$1() && !n.startsWith("http") && (n = "https:".concat(n)), t.type = e.remoteEntryType, t.entryGlobalName = e.globalName, t.entry = n, t.version = e.version, t.buildVersion = e.buildVersion;
}
...
function traverseModuleInfo(t, e, r, n) {
    let o = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {}, s = arguments.length > 5 ? arguments[5] : void 0;
...
function generatePreloadAssets(t, e, r, n, o) {
    ...
    if (traverseModuleInfo(n, r, (p, y, b)=>{
        ...
        if (M) {
            const w = M.length;
            for(let N = 0; N < w; N++){
                const D = M[N], x = "".concat(y.name, "/").concat(D.moduleName);
    ...
    async getManifestJson(e, r, n) {
        const o = async ()=>{
            ...
            try {
                ...
                return (!a || !(a instanceof Response)) && (a = await fetch(e, {})), i = await a.json(), assert(i.metaData && i.exposes && i.shared, "".concat(e, " is not a federation manifest")), this.manifestCache.set(e, i), i;
            } catch (a) {
                error("Failed to get manifestJson for ".concat(r.name, ". The manifest URL is ").concat(e, ". Please ensure that the manifestUrl is accessible.\n          \n Error message:\n          \n ").concat(a));
            }
        }, s = async ()=>{
...
class SharedHandler {
    ...
    async loadShare(e, r) {
        ...
        assert(i, "Cannot find ".concat(e, " Share in the ").concat(n.options.name, ". Please ensure that the ").concat(e, " Share parameters have been injected"));
        ...
        if (a && a.loading && !a.loaded) {
            ...
            if (r != null && r.customShareInfo) return !1;
            const l = (async ()=>{
                const u = await i.get();
                i.lib = u, i.loaded = !0, c(i);
                const d = getRegisteredShare(this.shareScopeMap, e, i, this.hooks.lifecycle.resolveShare);
    ...
    initializeSharing() {
        let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : DEFAULT_SCOPE, r = arguments.length > 1 ? arguments[1] : void 0;
    ...
    loadShareSync(e, r) {
        ...
        if (s) {
            if (typeof s.lib == "function") return i(s), s.loaded || (s.loaded = !0, s.from === n.options.name && (o.loaded = !0)), s.lib;
            if (typeof s.get == "function") {
                const a = s.get();
                if (!(a instanceof Promise)) return i(s), this.setShared({
                    pkgName: e,
                    loaded: !0,
                    from: n.options.name,
                    lib: a,
    ...
    setShared(param) {
        let { pkgName: e, shared: r, from: n, lib: o, loading: s, loaded: i, get: a } = param;
...
class RemoteHandler {
    ...
    async getRemoteModuleAndOptions(e) {
        ...
        assert(i, "\n        Unable to locate ".concat(s, " in ").concat(r.options.name, ". Potential reasons for failure include:\n\n        1. ").concat(s, " was not included in the 'remotes' parameter of ").concat(r.options.name || "the host", ".\n\n        2. ").concat(s, " could not be found in the 'remotes' of ").concat(r.options.name, " with either 'name' or 'alias' attributes.\n        3. ").concat(s, " is not online, injected, or loaded.\n        4. ").concat(s, "  cannot be accessed on the expected.\n        5. The 'beforeRequest' hook was provided but did not return the correct 'remoteInfo' when attempting to load ").concat(s, ".\n      "));
        ...
        assert(u && d, "The 'beforeRequest' hook was executed, but it failed to return the correct 'remote' and 'expose' values while loading ".concat(s, "."));
    ...
    registerRemote(e, r, n) {
        const { host: o } = this, s = ()=>{
            if (e.alias) {
                ...
                assert(!a, "The alias ".concat(e.alias, " of remote ").concat(e.name, " is not allowed to be the prefix of ").concat(a && a.name, " name or alias"));
            }
        ...
        if (!i) s(), r.push(e), this.hooks.lifecycle.registerRemote.emit({
            remote: e,
            origin: o
        });
        else {
            const a = [
                'The remote "'.concat(e.name, '" is already registered.'),
    ...
    removeRemote(e) {
        ...
        if (s) {
            ...
            if (d !== -1) {
                ...
                }), p && (h.shareScopeMap = {}, delete m[u]), y.forEach((param)=>{
                    let [b, g, I, M] = param;
                    var A, E, S;
...
function __generator(t, e) {
    var r = {
        ...
        trys: [],
        ops: []
    }, n, o, s, i = Object.create((typeof Iterator == "function" ? Iterator : Object).prototype);
    ...
    function c(l) {
        ...
        for(; i && (i = 0, l[0] && (r = 0)), r;)try {
            if (n = 1, o && (s = l[0] & 2 ? o.return : l[0] ? o.throw || ((s = o.return) && s.call(o), 0) : o.next) && !(s = s.call(o, l[1])).done) return s;
            switch(o = 0, s && (l = [
                l[0] & 2,
                s.value
            ]), l[0]){
...
var E_CANCELED = new Error("request for lock canceled"), Semaphore = function() {
    ...
    return t.prototype.acquire = function(e, r) {
        var n = this;
        if (e === void 0 && (e = 1), r === void 0 && (r = 0), e <= 0) throw new Error("invalid weight ".concat(e, ": must be positive"));
        return new Promise(function(o, s) {
            var i = {
                ...
                weight: e,
                priority: r
            }, a = findIndexFromEnd(n._queue, function(c) {
                return r <= c.priority;
            });
...
function detectMetaMaskProvider(t) {
    let { timeout: e = 3e3 } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    let r = !1;
    return new Promise((n)=>{
        ...
        typeof t.addEventListener == "function" && t.addEventListener("eip6963:announceProvider", o), setTimeout(()=>{
            r || n(null);
        }, e), typeof t.dispatchEvent == "function" && t.dispatchEvent(new Event("eip6963:requestProvider"));
    });
}
async function waitForMetaMaskProvider(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const { timeout: r = 3e3, retries: n = 0 } = e;
    let o = null;
    try {
        o = await detectMetaMaskProvider(t, {
            timeout: r
        });
    } catch (e) {}
    return o || (n === 0 ? null : (o = await waitForMetaMaskProvider({
        timeout: r,
        retries: n - 1
    }), o));
}
...
class MetaMaskVirtualWallet {
    ...
    async request(e) {
        return _(this, R, H).call(this).then((r)=>r.request(e));
    }
    on(e, r) {
        _(this, R, H).call(this).then((n)=>n.on(e, r));
    }
    off(e, r) {
        _(this, R, H).call(this).then((n)=>n.off(e, r));
    }
    constructor(){
        ...
        remotes: [
            {
                ...
                entry: "https://snaps.consensys.io/starknet/get-starknet/v1/remoteEntry.js?ts=".concat(Date.now())
            }
        ]
    });
...
}, R = /* @__PURE__ */ new WeakSet(), H = async function() {
...
const wallets = [
    ...
    },
    {
        ...
        downloads: {
            ...
            ios: "https://link.braavos.app/dapp/".concat((X = ssrSafeWindow$1 == null ? void 0 : ssrSafeWindow$1.location) == null ? void 0 : X.host),
            android: "https://link.braavos.app/dapp/".concat((K = ssrSafeWindow$1 == null ? void 0 : ssrSafeWindow$1.location) == null ? void 0 : K.host)
        }
    },
    {
...
class LocalStorageWrapper {
    set(e) {
        return !v(this, C) && !_(this, k, W).call(this) ? !1 : (this.delete(), this.value = e, e && (G(this, T, "".concat(v(this, P), "-").concat(generateUID())), localStorage.setItem(v(this, T), e)), !0);
    }
    get() {
...
C = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), ee = function() {
    ...
    try {
        !v(this, C) && typeof window < "u" && (G(this, T, Object.keys(localStorage).find((t)=>t.startsWith(v(this, P)))), G(this, C, !0), v(this, T) && this.set(localStorage.getItem(v(this, T))));
    } catch (t) {
        console.warn(t);
    }
    return v(this, C);
...
const filterByAuthorized = async (t)=>{
    const e = await Promise.all(t.map(async (r)=>{
        try {
...
function getStarknet() {
    ...
    return initiateVirtualWallets(r), {
        getAvailableWallets: async function() {
            let s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            const i = scanObjectForWallets(r, n);
            return pipe$1((a)=>filterBy(a, s), (a)=>sortBy(a, s.sort))(i);
        },
        getAuthorizedWallets: async function() {
            let s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            const i = scanObjectForWallets(r, n);
            return pipe$1((a)=>filterByAuthorized(a), (a)=>filterBy(a, s), (a)=>sortBy(a, s.sort))(i);
        },
        getDiscoveryWallets: async function() {
            let s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return pipe$1((i)=>filterBy(i, s), (i)=>sortBy(i, s.sort))(wallets);
        },
        getLastConnectedWallet: async ()=>{
            const s = o.get(), i = scanObjectForWallets(r, n).find((c)=>c.id === s), [a] = await filterByAuthorized(i ? [
                i
            ] : []);
            return a || (o.delete(), null);
        },
        discoverVirtualWallets: async function() {
            let s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
            const i = new Set(s), a = i.size > 0 ? virtualWallets.filter((c)=>i.has(c.name) || i.has(c.id)) : virtualWallets;
        ...
        enable: async (s, i)=>{
            let a;
            if (isVirtualWallet(s)) a = await resolveVirtualWallet(r, s);
            else if (isFullWallet(s)) a = s;
        ...
        disconnect: async function() {
            let { clearLastWallet: s } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            s && o.delete();
        }
    };
}
...
class Parser {
    ...
    satisfies(e) {
        ...
        if (Object.keys(e).forEach((a)=>{
            ...
            const l = Utils.find(a, (u)=>this.isPlatform(u));
            if (l) {
    ...
    compareVersion(e) {
        ...
        if (typeof s == "string") return e[0] === ">" || e[0] === "<" ? (n = e.substr(1), e[1] === "=" ? (o = !0, n = e.substr(2)) : r = [], e[0] === ">" ? r.push(1) : r.push(-1)) : e[0] === "=" ? n = e.substr(1) : e[0] === "~" && (o = !0, n = e.substr(1)), r.indexOf(Utils.compareVersions(s, n, o)) > -1;
    }
    isOS(e) {
...
const enableWithVersion = async (t, e)=>t ? main.enable(t, e).catch(()=>null) : null, connect = async function() {
    let { modalMode: t = "canAsk", storeVersion: e = getBrowserStoreVersionFromBrowser(), osVersion: r = getOperatingSystemStoreVersionFromBrowser(), modalTheme: n, ...o } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    var u, d;
    ...
    if (t === "canAsk" && i) {
        ...
        if (h) return enableWithVersion(h);
    }
    const l = (await main.getDiscoveryWallets(o)).reduce((h, m)=>{
        const p = m.downloads[r] || m.downloads[e];
        if (p) {
            const y = Object.keys(m.downloads).find((I)=>m.downloads[I] === p), g = y === "android" || y === "ios" ? "".concat(m.name, " Mobile") : "Install ".concat(m.name);
            h.push({
                ...m,
                name: g,
                download: p
...
//# sourceMappingURL=node_modules_%40starknet-io_get-starknet_dist_ui_6a083bcd.js.map
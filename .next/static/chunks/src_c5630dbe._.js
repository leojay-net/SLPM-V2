            ...
            try {
                ...
                if (atomiqClientRef.current) {
                    try {
                        ...
                        const satsPerStrk = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENV"].STRK_SATS_RATE || 125;
    ...
    const initiateStrkToZec = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useCrossChainSwap.useCallback[initiateStrkToZec]": async (strkAmount, zecAddress, walletSigner // Starknet wallet signer
            ...
            try {
                ...
                console.log("Estimated STRK → Lightning: ".concat(strkAmount, " STRK → ").concat(estimatedSats, " sats"));
...
function CrossChainSwap() {
    ...
    const { isConnected, address, connect, disconnect, isReady: walletReady, client: walletClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$WalletProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
...
_s(CrossChainSwap, "yuBCBSn/l9VeMFcvrCG5f6aiwNI=", false, function() {
    return [

module.exports = [
"[project]/node_modules/@starknet-io/get-starknet/dist/ui.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function init$1(t, e, r, n, o, s, i, a = [
    -1
]) {
...
function instance(t, e, r) {
    const n = "undefined" < "u" ? window : null;
...
async function show({ discoveryWallets: t, installedWallets: e, lastWallet: r, authorizedWallets: n, enable: o, modalOptions: s }) {
...
const ssrSafeWindow$1 = "undefined" < "u" ? window : null;
...
function safeGetLocalStorageItem() {
    try {
        if ("undefined" < "u" && window.localStorage) return localStorage.getItem(BROWSER_LOG_KEY) === BROWSER_LOG_VALUE;
    } catch  {
...
C = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), ee = function() {
    ...
    try {
        !v(this, C) && "undefined" < "u" && (G(this, T, Object.keys(localStorage).find((t)=>t.startsWith(v(this, P)))), G(this, C, !0), v(this, T) && this.set(localStorage.getItem(v(this, T))));
    } catch (t) {
        console.warn(t);
    }
    return v(this, C);
...
function getStarknet(t = {}) {
    ...
    return initiateVirtualWallets(r), {
        ...
        getDiscoveryWallets: async (s = {})=>pipe$1((i)=>filterBy(i, s), (i)=>sortBy(i, s.sort))(wallets),
...
const ssrSafeWindow = "undefined" < "u" ? window : null;
...
const enableWithVersion = async (t, e)=>t ? main.enable(t, e).catch(()=>null) : null, connect = async ({ modalMode: t = "canAsk", storeVersion: e = getBrowserStoreVersionFromBrowser(), osVersion: r = getOperatingSystemStoreVersionFromBrowser(), modalTheme: n, ...o } = {})=>{
    var u, d;
    ...
    const l = (await main.getDiscoveryWallets(o)).reduce((h, m)=>{
        ...
        if (p) {
            const y = Object.keys(m.downloads).find((I)=>m.downloads[I] === p), g = y === "android" || y === "ios" ? `${m.name} Mobile` : `Install ${m.name}`;
            h.push({
                ...m,
                name: g,
                download: p
...
//# sourceMappingURL=node_modules_%40starknet-io_get-starknet_dist_ui_b83e1fde.js.map
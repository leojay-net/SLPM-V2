module.exports = [
"[project]/node_modules/starknet/dist/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var jsonrpc_exports = {};
// src/types/api/index.ts
var RPCSPEC07 = __toESM(__turbopack_context__.r("[project]/node_modules/@starknet-io/starknet-types-07/dist/cjs/index.js [app-ssr] (ecmascript)"));
var RPCSPEC08 = __toESM(__turbopack_context__.r("[project]/node_modules/@starknet-io/starknet-types-08/dist/cjs/index.js [app-ssr] (ecmascript)"));
var import_starknet_types_08 = __turbopack_context__.r("[project]/node_modules/@starknet-io/starknet-types-08/dist/cjs/index.js [app-ssr] (ecmascript)");
__reExport(api_exports, __turbopack_context__.r("[project]/node_modules/@starknet-io/starknet-types-08/dist/cjs/index.js [app-ssr] (ecmascript)"));
// src/utils/encode.ts
var encode_exports = {};
...
var import_base = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@scure/base/lib/index.js [app-ssr] (ecmascript)");
...
var RPCSPEC082 = __toESM(__turbopack_context__.r("[project]/node_modules/@starknet-io/starknet-types-08/dist/cjs/index.js [app-ssr] (ecmascript)"));
...
var import_starknet_types_07 = __turbopack_context__.r("[project]/node_modules/@starknet-io/starknet-types-07/dist/cjs/index.js [app-ssr] (ecmascript)");
// src/utils/json.ts
var json_exports = {};
...
var json = __toESM(__turbopack_context__.r("[project]/node_modules/lossless-json/lib/umd/lossless-json.js [app-ssr] (ecmascript)"));
...
var import_utils = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/abstract/utils.js [app-ssr] (ecmascript)");
var import_sha256 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/hashes/sha256.js [app-ssr] (ecmascript)");
// src/utils/typed.ts
...
var import_starknet = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@scure/starknet/lib/index.js [app-ssr] (ecmascript)");
var import_sha3 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/hashes/sha3.js [app-ssr] (ecmascript)");
var import_utils2 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/abstract/utils.js [app-ssr] (ecmascript)");
...
var poseidon = __toESM(__turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/abstract/poseidon.js [app-ssr] (ecmascript)"));
...
var starkCurve = __toESM(__turbopack_context__.r("[project]/node_modules/starknet/node_modules/@scure/starknet/lib/index.js [app-ssr] (ecmascript)"));
var weierstrass = __toESM(__turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/abstract/weierstrass.js [app-ssr] (ecmascript)"));
// src/utils/hash/transactionHash/v2.ts
...
var import_starknet2 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@scure/starknet/lib/index.js [app-ssr] (ecmascript)");
...
var import_starknet3 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@scure/starknet/lib/index.js [app-ssr] (ecmascript)");
...
var import_starknet4 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@scure/starknet/lib/index.js [app-ssr] (ecmascript)");
var import_pako = __turbopack_context__.r("[project]/node_modules/pako/index.js [app-ssr] (ecmascript)");
...
var import_secp256k1 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/secp256k1.js [app-ssr] (ecmascript)");
...
function identifyRevision({ types: types1, domain }) {
    if (revisionConfiguration[import_starknet_types_07.TypedDataRevision.ACTIVE].domain in types1 && domain.revision?.toString() === import_starknet_types_07.TypedDataRevision.ACTIVE) return import_starknet_types_07.TypedDataRevision.ACTIVE;
    if (revisionConfiguration[import_starknet_types_07.TypedDataRevision.LEGACY].domain in types1 && (domain.revision ?? import_starknet_types_07.TypedDataRevision.LEGACY) === import_starknet_types_07.TypedDataRevision.LEGACY) return import_starknet_types_07.TypedDataRevision.LEGACY;
    return void 0;
}
...
function getDependencies(types1, type, dependencies = [], contains = "", revision = import_starknet_types_07.TypedDataRevision.LEGACY) {
    let dependencyTypes = [
        type
    ];
...
function encodeType(types1, type, revision = import_starknet_types_07.TypedDataRevision.LEGACY) {
...
function getTypeHash(types1, type, revision = import_starknet_types_07.TypedDataRevision.LEGACY) {
    return getSelectorFromName(encodeType(types1, type, revision));
}
function encodeValue(types1, type, data, ctx = {}, revision = import_starknet_types_07.TypedDataRevision.LEGACY) {
    if (types1[type]) {
        return [
            type,
...
function encodeData(types1, type, data, revision = import_starknet_types_07.TypedDataRevision.LEGACY) {
    const targetType = types1[type] ?? revisionConfiguration[revision].presetTypes[type];
...
function getStructHash(types1, type, data, revision = import_starknet_types_07.TypedDataRevision.LEGACY) {
...
var import_ts_mixer = __turbopack_context__.r("[project]/node_modules/ts-mixer/dist/esm/index.js [app-ssr] (ecmascript)");
...
var import_secp256k12 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/secp256k1.js [app-ssr] (ecmascript)");
...
var import_utils3 = __turbopack_context__.r("[project]/node_modules/starknet/node_modules/@noble/curves/abstract/utils.js [app-ssr] (ecmascript)");
...
var WalletAccount = class _WalletAccount extends Account {
    ...
    constructor(providerOrOptions, walletProvider, address, cairoVersion, paymaster1){
        super(providerOrOptions, address, "", cairoVersion, void 0, paymaster1);
   ...
   */ execute(calls) {
    ...
    static async connect(provider1, walletProvider, cairoVersion, paymaster1, silentMode = false) {
...
//# sourceMappingURL=node_modules_starknet_dist_index_9cd4e3cf.js.map
module.exports = [
"[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const secp256k1_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/node_modules/@noble/curves/secp256k1.js [app-ssr] (ecmascript)");
const ripemd160_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/node_modules/@noble/hashes/ripemd160.js [app-ssr] (ecmascript)");
const sha256_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/node_modules/@noble/hashes/sha256.js [app-ssr] (ecmascript)");
...
const micro_packed_1 = __turbopack_context__.r("[project]/node_modules/micro-packed/lib/index.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/@scure/btc-signer/script.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const P = __turbopack_context__.r("[project]/node_modules/micro-packed/lib/index.js [app-ssr] (ecmascript)");
const utils_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
...
exports.Script = P.wrap({
    encodeStream: (w, value)=>{
        for (let o of value){
            ...
            if (!(0, utils_js_1.isBytes)(o)) throw new Error(`Wrong Script OP=${o} (${typeof o})`);
            // Bytes
            const len = o.length;
...
"[project]/node_modules/@scure/btc-signer/utxo.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const P = __turbopack_context__.r("[project]/node_modules/micro-packed/lib/index.js [app-ssr] (ecmascript)");
const payment_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/payment.js [app-ssr] (ecmascript)");
const psbt = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/psbt.js [app-ssr] (ecmascript)");
const script_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/script.js [app-ssr] (ecmascript)");
const transaction_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/transaction.js [app-ssr] (ecmascript)"); // circular
const utils_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
// Normalizes input
...
function normalizeInput(i, cur, allowedFields, disableScriptCheck = false) {
    ...
    if (!('nonWitnessUtxo' in i) && nonWitnessUtxo === undefined) nonWitnessUtxo = cur?.nonWitnessUtxo;
...
function getScript(o, opts = {}, network = utils_js_1.NETWORK) {
    ...
    if ('address' in o) {
        if (typeof o.address !== 'string') throw new Error(`Estimator: wrong output address=${o.address}`);
...
class _Estimator {
    constructor(inputs, outputs, opts){
        ...
        if (typeof opts.feePerByte !== 'bigint') throw new Error(`Estimator: wrong feePerByte=${opts.feePerByte}, should be of type bigint but got ${typeof opts.feePerByte}.`);
        // Dust stuff
        ...
        if (opts.requiredInputs !== undefined && !Array.isArray(opts.requiredInputs)) throw new Error(`Estimator: wrong required inputs=${opts.requiredInputs}`);
        ...
        if (typeof opts.changeAddress !== 'string') throw new Error(`Estimator: wrong change address=${opts.changeAddress}`);
        ...
        this.normalizedInputs = allInputs.map((i)=>{
            ...
            if (!opts.allowSameUtxo && inputKeys.has(key)) throw new Error(`Estimator: same input passed multiple times: ${key}`);
            inputKeys.add(key);
    ...
    checkInputIdx(idx) {
        if (!Number.isSafeInteger(idx) || 0 > idx || idx >= this.normalizedInputs.length) throw new Error(`Wrong input index=${idx}`);
        return idx;
    }
    sortIndices(indices) {
...
"[project]/node_modules/@scure/btc-signer/transaction.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const P = __turbopack_context__.r("[project]/node_modules/micro-packed/lib/index.js [app-ssr] (ecmascript)");
const payment_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/payment.js [app-ssr] (ecmascript)");
const psbt = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/psbt.js [app-ssr] (ecmascript)"); // circular
const script_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/script.js [app-ssr] (ecmascript)");
const u = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
const utils_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
const utxo_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utxo.js [app-ssr] (ecmascript)"); // circular
...
function validateOpts(opts) {
    if (opts !== undefined && ({}).toString.call(opts) !== '[object Object]') throw new Error(`Wrong object type for transaction options: ${opts}`);
    const _opts = {
        ...opts,
        // Defaults
    ...
    if (![
        ...
        2,
        3
    ].includes(_opts.version)) throw new Error(`Unknown version: ${_opts.version}`);
    ...
    if (_opts.customScripts !== undefined) {
        ...
        for (const s of cs){
            if (typeof s.encode !== 'function' || typeof s.decode !== 'function') throw new Error(`wrong script=${s} (${typeof s})`);
            if (s.finalizeTaproot !== undefined && typeof s.finalizeTaproot !== 'function') throw new Error(`wrong script=${s} (${typeof s})`);
        }
    }
...
"[project]/node_modules/@scure/btc-signer/psbt.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.PSBTInputCoder = P.validate(PSBTKeyMap(exports.PSBTInput), (i)=>{
    ...
    if (i.nonWitnessUtxo && i.index !== undefined && i.txid) {
        ...
        if (tx.isFinal && tx.id !== txid) throw new Error(`nonWitnessUtxo: wrong txid, exp=${txid} got=${tx.id}`);
    }
    return i;
});
...
function mergeKeyMap(psbtEnum, val, cur, allowedFields) {
    ...
    for(const k in psbtEnum){
        ...
        if (val[k] === undefined && k in val) {
            ...
            if (!(0, utils_js_1.equalBytes)(vC.encode(val[k]), vC.encode(cur[k]))) throw new Error(`Cannot change signed field=${k}`);
        }
    }
    // Remove unknown keys
...
"[project]/node_modules/@scure/btc-signer/payment.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const base_1 = __turbopack_context__.r("[project]/node_modules/@scure/base/lib/index.js [app-ssr] (ecmascript)");
const P = __turbopack_context__.r("[project]/node_modules/micro-packed/lib/index.js [app-ssr] (ecmascript)");
const psbt_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/psbt.js [app-ssr] (ecmascript)");
const script_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/script.js [app-ssr] (ecmascript)");
const u = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
const utils_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
const OutP2A = {
...
exports.OutScript = P.validate(_OutScript, (i)=>{
    ...
    if ((i.type === 'pkh' || i.type === 'sh' || i.type === 'wpkh') && (!u.isBytes(i.hash) || i.hash.length !== 20)) throw new Error(`OutScript/${i.type}: wrong hash`);
    ...
    if (i.type === 'tr_ns' || i.type === 'tr_ms') {
        for (const p of i.pubkeys)if (!isValidPubkey(p, u.PubT.schnorr)) throw new Error(`OutScript/${i.type}: wrong pubkey`);
    }
    if (i.type === 'tr_ms') {
        const n = i.pubkeys.length;
...
function uniqPubkey(pubkeys) {
    ...
    for (const pub of pubkeys){
        ...
        if (map[key]) throw new Error(`Multisig: non-uniq pubkey: ${pubkeys.map(base_1.hex.encode)}`);
        map[key] = true;
    }
}
// @ts-ignore
...
function checkTaprootScript(script, internalPubKey, allowUnknownOutputs = false, customScripts) {
    ...
    if (out.type === 'unknown') {
        ...
        if (customScripts) {
            ...
            if (c !== undefined) {
                if (typeof c.type !== 'string' || !c.type.startsWith('tr_')) throw new Error(`P2TR: invalid custom type=${c.type}`);
                return;
            }
        }
    ...
    if (![
        'tr_ns',
        'tr_ms'
    ].includes(out.type)) throw new Error(`P2TR: invalid leaf script=${out.type}`);
    const outms = out;
...
const tapLeafHash = (script, version = exports.TAP_LEAF_VERSION)=>u.tagSchnorr('TapLeaf', new Uint8Array([
        version
...
"[project]/node_modules/@scure/btc-signer/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/*! scure-btc-signer - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const utils_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
// should multisig be exported as classicMultisig?
// prettier-ignore
var payment_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/payment.js [app-ssr] (ecmascript)");
...
var script_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/script.js [app-ssr] (ecmascript)");
...
var transaction_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/transaction.js [app-ssr] (ecmascript)");
...
var utils_js_2 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utils.js [app-ssr] (ecmascript)");
...
var utxo_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utxo.js [app-ssr] (ecmascript)");
...
var payment_js_2 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/payment.js [app-ssr] (ecmascript)"); // remove
...
var psbt_js_1 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/psbt.js [app-ssr] (ecmascript)"); // remove
...
var transaction_js_2 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/transaction.js [app-ssr] (ecmascript)"); // remove
...
var utxo_js_2 = __turbopack_context__.r("[project]/node_modules/@scure/btc-signer/utxo.js [app-ssr] (ecmascript)");
...
//# sourceMappingURL=node_modules_%40scure_btc-signer_4f476260._.js.map
...
function randomHex(bytes = 32) {
  return utils.bytesToHex(utils.randomBytes(bytes));
}
function hash(data) {
  const input = typeof data === "string" ? utils.hexToBytes(data.replace("0x", "")) : data;
  return "0x" + utils.bytesToHex(sha256.sha256(input));
}
...
var PrivacyMixer = class {
  constructor(config, wallet, eventCallback) {
    ...
    this.contract = new starknet.Contract(MIXER_ABI, contractAddress, wallet.provider);
...
exports.CASHU_MINTS = CASHU_MINTS;
exports.CURRENCIES = CURRENCIES;
exports.CashuWallet = CashuWallet;
exports.CrossChainSwapper = CrossChainSwapper;
exports.MAINNET_CONTRACTS = MAINNET_CONTRACTS;
exports.MIXER_CONFIG = MIXER_CONFIG;
exports.PrivacyMixer = PrivacyMixer;
exports.RPC_URLS = RPC_URLS;
exports.SEPOLIA_CONTRACTS = SEPOLIA_CONTRACTS;
exports.SLPM = SLPM;
exports.SWAP_CONFIG = SWAP_CONFIG;

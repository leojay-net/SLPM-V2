...
export async function stepWithdraw(
    ...
    console.log('🏦 SLPM Withdraw: Starting withdrawal step');
    ...
    try {
        ...
        for (let i = 0; i < destinations.length; i++) {
            ...
            console.log(`🏦 SLPM Withdraw: Processing withdrawal ${i + 1}/${destinations.length}`);
            console.log(`🏦 SLPM Withdraw: Destination: ${destination.slice(0, 10)}...${destination.slice(-6)}`);
            console.log(`🏦 SLPM Withdraw: Amount: ${amountPerDestination} STRK (${amountWei} wei)`);

            // Generate ZK proof for withdrawal (simplified)
            console.log('🔐 SLPM Withdraw: Generating ZK proof for withdrawal...');
            ...
            console.log('🔐 SLPM Withdraw: ZK proof generated:', {
            ...
            console.log('📤 SLPM Withdraw: Submitting withdrawal to mixer contract...');
            try {
                ...
                console.log(`✅ SLPM Withdraw: Withdrawal ${i + 1} submitted:`, withdrawalTxHash);
                ...
                console.log(`✅ SLPM Withdraw: Withdrawal ${i + 1} confirmed:`, confirmedTx);

            } catch (error) {
                console.error(`❌ SLPM Withdraw: Failed withdrawal ${i + 1}:`, error);
            ...
            if (i < destinations.length - 1) {
                ...
                console.log(`⏳ SLPM Withdraw: Privacy delay: ${delay}ms`);
                await new Promise(resolve => setTimeout(resolve, delay));
            }
        }

        console.log('✅ SLPM Withdraw: All withdrawals completed successfully');
        onEvent({
            type: 'mix:progress',
